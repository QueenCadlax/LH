  ...
  const handleSuggestionClick = (suggestion: { text: string, type: string }) => {
    ...
    return (
      ...
      <style>{`@keyframes wave { 0%, 100% { transform: translateY(0); color: inherit; } 50% { transform: translateY(-10px); color: #E3B92C; } }`}</style>
            ...
            <ActivityTicker />
            <SponsoredSection />
            <section className="py-20 sm:py-24 md:py-32 bg-[#050505]">
              <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8">
                <div className="max-w-2xl mx-auto">
                  {/* Subtle gold accent line */}
                  <div className="h-px w-12 bg-gradient-to-r from-transparent via-gold-400 to-transparent mx-auto mb-12 sm:mb-14 md:mb-16" style={{ animation: 'fadeIn 1.2s ease-out' }} />
                  
                  {/* Editorial statement */}
                  <div className="text-center">
                    <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-serif text-white leading-relaxed opacity-95" style={{ letterSpacing: '0.3px', animation: 'fadeIn 1s ease-out' }}>
                      LOWVELDHUB exists to spotlight the finest experiences, businesses, and destinations across Mpumalanga within one refined digital ecosystem.
                    </p>
                    
                    {/* Optional tiny caption */}
                    <p className="text-xs sm:text-sm text-gray-500 mt-8 sm:mt-10 md:mt-12 font-light tracking-widest uppercase" style={{ letterSpacing: '0.15em' }}>Curated for the Lowveld</p>
                  </div>
                </div>
              </div>
